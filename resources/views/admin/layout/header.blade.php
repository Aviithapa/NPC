<header class="main-header"> 
  ...
  <span class="logo-mini"><img src="{{ assets('dist/img/npc.webp') }}" alt="" width="50" height="50">Nepal Pharmacy Council </span> 
  <!-- logo for regular state and mobile devices --> 
  <span class="logo-lg"><img src="{{ assets('dist/img/npc.webp') }}" alt=""></span> </a> 
  <!-- Header Navbar -->
        ...
        <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="" class="user-image" alt="User Image"> <span class="hidden-xs">Abhishek Thapa</span> </a>
          <ul class="dropdown-menu">
            <li class="user-header">
              ...
              <p class="text-left">Abhishek Thapa <small>abhishekthapa115@gmail.com</small> </p>
            </li>
